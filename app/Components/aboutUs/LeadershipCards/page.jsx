...
const LeadershipCard = ({ image, name, title, socialLinks }) => {
  return (
    <div className="">
      {/* <div className="font-[sans-serif] lg:max-w-5xl sm:max-w-2xl max-sm:max-w-sm mx-auto mt-4">
                ...
                <div className="grid grid-cols-3 items-center bg-gray-100 p-4 rounded-lg relative">
                    <div className="col-span-2 min-h-[190px]">
                        <Image src={image} className="rounded-lg" alt={name} />
                    </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-md hover:scale-105 transition-all duration-500">
          <div className="lg:min-h-[250px]">
            <Image
              src={image}
              alt={name}
              className=" h-60 object-contain rounded-lg inline-block  bg-[#E9F2F8]"
            />
          </div>

          <div className="mt-6">
            <h4 className="text-gray-800 text-lg font-bold">{name}</h4>
